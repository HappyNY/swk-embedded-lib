...
TEST_CASE( "Timer logic functionality test", "[timer-logic]" )
{
    ...
    h[0] = timer_add( &s, 2000, [] ( void* o ) {*( double*) o = 2.0; }, & v );
    h[1] = timer_add( &s, 1000, [] ( void* o ) {*( double*) o = 1.0; }, & v );
    auto x = h[2] = timer_add( &s, 3000, [] ( void* o ) {*( double*) o = 3.0; }, &v );
    ...
    {
        h[3 + i] = timer_add( &s, 4000 + i * 1000, [] ( void* o ) { *( double*) o += 1.0; }, &v );
    }
